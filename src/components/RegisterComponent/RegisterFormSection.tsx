...
const RegisterFormSection = () => {
    ...
    return (
        <form method={"POST"} noValidate className={"flex flex-col gap-4"} onSubmit={onSubmit}>
            <div className={"flex flex-col gap-1"}>
                <div className={"flex flex-col sm:items-center sm:flex-row gap-4"}>
                    <div className={"flex flex-col gap-1"}>
                        ...
                        <Input id={"firstName"} type={"text"} required autoComplete={"given-name"} aria-describedby={"firstName-error"} value={values.first_name} onChange={handleChange} name={"first_name"} placeholder={"Enter your first name"}/>
                    ...
                    <div className={"flex flex-col gap-1"}>
                        ...
                        <Input id={"lastName"} type={"text"} required autoComplete={"family-name"} aria-describedby={"lastName-error"} value={values.last_name} onChange={handleChange} name={"last_name"} placeholder={"Enter your last name"}/>
                ...
                <div className={"flex flex-col gap-1"}>
                    ...
                    <Input id={"password"} type={"password"} required autoComplete={"new-password"} name={"password"} aria-describedby={"password-error"} value={values.password} onChange={handleChange} placeholder={"Enter your password"}/>
