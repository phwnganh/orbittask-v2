...
const MembersSearch = ({keyword, onChange, placeholder, ...props}: MembersSearchProps) => {

    return (
        <div className={"relative w-full group"}>
            <Input {...props} placeholder={placeholder} className={"pr-10"} value={keyword} onChange={onChange}/>
