...
import CommentActivityActions from "@/features/task-detail/components/task-detail-activity/task-activity-content/comment-activity/CommentActivityActions.tsx";
...
const CommentActivity = ({
  ...
  return (
    <div
      className={
        "mt-2 group relative rounded-md border border-border-primary bg-bg-secondary px-3 py-2 transition"
      }
    >
      {isMe && editing ? (
        <>
